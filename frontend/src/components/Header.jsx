    ...
    <nav className="absolute rounded-lg px-10 py-3 w-full  top-0">
      <div className="flex items-center justify-between ">
        <div className="flex items-center">
          <Link className='nun-font-700 text-[20px] duration-[300ms]' to='/'><span>Local Store</span></Link>
        </div>

        <ul className='flex '>
          <>
            <li >
              <Link className='flex nun-font-600 items-center mx-[20px] text-[18px]' to='/login'>
